...
// Importing the library which generates RANDOM PASSWORD
...
class User {
  ...
  static async get(username) {
    ...
    // Getting the applications IDs applied by the user
  ...
  **/
  ...
  static async applyToJob(username, jobId) { 
    ...
    // Inserting the new entry into the applications table
    await db.query(
